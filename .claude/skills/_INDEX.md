...
| [wire-before-claim.md](wire-before-claim.md) | A built mechanism is not protection until something CALLS it — verify standing caller (workflow/hook/installer) + registry reference + target existence against the repo's reality, never against the claim. Catches orphan gates, 0-test runners, ghost e2e. | meta, process, gating, wiring, verification, anti-tunnel-vision | wave-meta-gates | experimental | global |
