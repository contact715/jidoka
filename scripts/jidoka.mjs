...
export const CMDS = {
  ...
  'model-route': { s: 'model-router.mjs', help: 'route agent calls and dev work (Fable 5 planning/review vs Codex 5.5 execution)' },
  relay: { s: 'jidoka-relay.mjs', help: 'local no-API handoff queue between Claude Fable 5 and Codex GPT-5.5' },
