...
// @divergence: "РАСХОЖДЕНИЕ: core.hooksPath задан, но копия остаётся без защиты" —
//              измеряемая величина «настройка задана» говорит «чисто», а правило
//              «хуки реально запускаются» нарушено: каталога нет именно в этой копии
//
