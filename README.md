...
```
.claude/
  agents/            43 агента-роли + _TEMPLATE (полная продуктовая студия: продукт/архитектура/build/дизайн/данные/запуск/качество) (chief-architect, reflexion-critic,
...
scripts/             117 скриптов-движка (102 .mjs + 15 .sh):
