# Agentic Engineering Framework для Claude Code

Привет, Юра. Это наша среда разработки — фреймворк поверх **Claude Code**, который превращает его из одиночного ассистента в многоагентный инженерный конвейер с code review, качественными гейтами, формальной верификацией и самоулучшением.

Здесь нет продукта — только сам фреймворк. То, что заставляет Claude Code писать код дисциплинированно, как команда senior-инженеров, а не «сгенерировал и закоммитил».
