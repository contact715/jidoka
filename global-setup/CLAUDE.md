...
Прибор смотрит ВНУТРЬ документа (32 самопроверки): источник без метки силы, статус
«есть»/«частично» без адреса файла, отсутствие раздела непроверенного, заглушки, и для
тяжёлого уровня — отсутствие приговоров, первого шага, стоимости. Ось у него другая,
